...
class CreateProfilesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('profiles', function (Blueprint $table) {
            ...
            $table->text('phone_checked')->comment('отметка о выборе')->nullable();
            ...
            $table->text('twitter')->comment('ссылка на twitter')->nullable();
            ...
            $table->text('favourites')->comment('содержит идентификаторы избранных пользователей')->nullable();
